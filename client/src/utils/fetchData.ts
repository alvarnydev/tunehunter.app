...
export const fetchData = async ({ queryKey }: { queryKey: [string, { searchParams: URLSearchParams }] }) => {
...
async function fetchApiData(artist: string, title: string, country: string, vendor: string): Promise<TrackInfoType[]> {
