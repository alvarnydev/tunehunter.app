...
const SearchModeToggler = ({ formData, handleFormUpdate }: { formData: FormDataType; handleFormUpdate: (newFormData: FormDataType) => void }) => {
  ...
  return (
    <label htmlFor='search-mode-switcher' className='swap swap-rotate md:order-1 order-3 m-auto'>
      <input id='search-mode-switcher' aria-labelledby='search-mode-switcher' type='checkbox' defaultChecked={formData.searchMode === 'playlist'} onChange={handleChange} />
